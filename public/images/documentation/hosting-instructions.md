...
- ssh into the server
    - For Mac and Linux: `ssh root@leahabraham.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo labraham1`
    - replace labraham1 with your own
- create password
    - `passwd labraham1`
- Move .ssh key file
    - `cp -r .ssh /home/labraham1`
- change ownership of the .ssh directory
    - `cd /home/labraham1`
    - `chown -R labraham1:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh labraham1@leahabraham.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/leahabraham.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/leahabraham.com/html`
...
- `sudo vim /etc/nginx/sites-available/leahabraham.com`
...
server {
    ...
    root /var/www/leahabraham.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name leahabraham.com www.leahabraham.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/leahabraham.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/labraham1/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/labraham1/.ssh/github_deploy_key.pub >> /home/labraham1/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/labraham1/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H leahabraham.com >> ~/.ssh/known_hosts 
         scp -r ./dist/* gkephart@leahabraham.com:/var/www/leahabraham.com/html
```
